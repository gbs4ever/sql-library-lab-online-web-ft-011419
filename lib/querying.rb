...
def select_name_and_series_subgenres_of_authors
  "SELECT DISTINCT Authors.name , Subgenres.name  From Authors JOIN series ON Authors.id = series.author_idseries  JOIN  Subgenres  ON series .id = series.subgenre_id  ;"
end
